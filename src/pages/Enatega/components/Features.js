              ...
              {FormRow(
                {
                  title: "User Friendly",
                  description:
                    "Enatega Is Easy To Use With User Friendly Interface.",
                  img: Artboard1,
                },
                {
                  title: "Quick Update",
                  description:
                    "Over the air updates has been integrated for quick updates",
                  img: Artboard2,
                },
                {
                  title: "High Performance",
                  description: "Highly performant with GrapQL integration",
                  img: Artboard3,
                }
              )}
            </Grid>
              ...
              {FormRow(
                {
                  title: "100% Secure",
                  description:
                    "User data is encrypted with latest encryption technologies",
                  img: Artboard4,
                },
                {
                  title: "Unlimited Features",
                  description:
                    "It is highly customizable with any feature that is required can be added on request",
                  img: Artboard5,
                },
                {
                  title: "Timely changes",
                  description:
                    "Our highly skilled team works around the clock to work on your features",
                  img: Artboard6,
                }
              )}
            </Grid>
