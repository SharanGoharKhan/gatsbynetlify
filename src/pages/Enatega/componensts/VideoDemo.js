...
const VideoDemo = (props) => {
    ...
    // console.log('matches video', matches)
    return (
        <>
            <div className={classes.root}>
                ...
                <iframe width={matches ? "600" : "300"} style={{borderRadius:20}} height={matches ? "315" : '200'} src="https://www.youtube.com/embed/nSwsapV30Vg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </>
