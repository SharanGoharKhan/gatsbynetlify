...
import { Typography, makeStyles, Grid, Button, useMediaQuery, useTheme, Link as MaterialLink } from '@material-ui/core';
import './Enatega.css'
                    ...
                    <Grid item xs={12} md={6} sm={12}>
                       ...
                       <Typography style={{ fontWeight: '600', lineHeight: '37px', fontFamily: 'Montserrat' }}>Note: This product is available with Expo client.</Typography></Typography>
                        ...
                        <Grid container justify="flex-start" alignItems="center">
                            ...
                            <Grid item xs={12} sm={4}>
                                <MaterialLink href="https://enatega-multi.gitbook.io/enatega-multivendor/" target="_blank" style={{ textDecoration: 'none' }}>
                                    <Button
                                        color="primary"
                                        size="large"
