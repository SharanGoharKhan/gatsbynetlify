                ...
                <Grid container spacing={8}>
                  ...
                  >
                    ...
                    <Typography variant="caption" className="color-groove">
                      ...
                      implement. Instead of requiring a completely new workflow
                      we integrate into your existing shipping system.
                    </Typography>
                  </Grid>
                  <Grid item md={6} align="center" data-aos="fade-left">
                    <div className="icon-container">
                    ...
                    <Typography variant="caption" className="color-groove">
                      ...
                      The result is a logical workflow with little to no
                      learning curve.
                    </Typography>
                  </Grid>
                </Grid>
              ...
              <Grid container spacing={5} alignItems="center">
                <Grid item md={6}>
                  <Typography
                    ...
                    data-aos-delay="1000"
                  >
                    PUT THE SMACK DOWN ON PACKING ERRORS AND ENJOY THE BENEFITS
                    OF REAL TIME PHYSICAL INVENTORY VISIBILITY.
                  </Typography>
                </Grid>
                <Grid item md={6}>
                  <img
