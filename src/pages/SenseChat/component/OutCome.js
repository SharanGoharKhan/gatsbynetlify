        ...
        <>
            <div className={classes.root}>
                <div style={{ backgroundColor: '#7F7FFF', padding: 5, width: 'fit-content', borderRadius: 3 }}>
                    <Typography style={{ color: '#fff' }}>4. OUTCOME AND BENEFITS</Typography>
                </div>
                <Typography variant="h5" gutterBottom style={{ lineHeight: '30px', marginTop: 20, fontFamily: 'Montserrat', fontSize: '5vmin', fontWeight: '700' }}>A stable solution with an excellent user experience</Typography>
                <Typography variant="h5" gutterBottom style={{ marginTop: 10, lineHeight: '30px', fontFamily: 'Montserrat', fontSize: '2vh' }}>The result of our work was achieving a stable solution with a low error rate that allowed to provide a flawless user experience. Moreover, it provided the ability to set up the WiFi network or the physical device without leaving the app and manually connect to the device’s hotspot. It resulted in making the whole user onboarding quick and effortless. </Typography>
