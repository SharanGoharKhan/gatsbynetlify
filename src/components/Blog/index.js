...
import { Card, IconButton, CardContent, CardActions, Button, Collapse, Divider, Typography, makeStyles, useMediaQuery, Grid, useTheme, Link as MaterialUILink } from '@material-ui/core';
    ...
    return (
        <div id="feature" className={classes.root}>
            ...
            <Grid container spacing={1} justify="space-evenly" alignItems="center">
                ...
                <Grid item lg={3} sm={12}>
                    <Card>
                        ...
                        <div style={{ paddingLeft: 10 }}>
                            <Typography style={{ fontFamily: 'Poppins', marginBottom: 10, fontWeight: 'bold', fontSize: '2.5vmin' }} color="black">
                                How to Make a Food Delivery App like UberEats, Foodpanda, GrubHub or Postmates
                            </Typography>
                            <Typography color="textSecondary" style={{ fontFamily: 'Poppins', lineHeight: '3.8vmin', fontSize: '2vmin' }}>
                                When building a food ordering app you need to think about many things how you are going to build it, who is going to use your food ordering app, and what are your competitors in this niche. Current companies that have dominated this market are Uber Eats, GrubHub, Just Eat, and Foodpanda.
                            </Typography>
                        </div>
                        <CardActions>
                            <MaterialUILink
            ...
            <div style={{ textAlign: 'center', marginTop: '10vmin' }}>
                <MaterialUILink
                    href="https://blog.ninjascode.com"
                    target="_blank">
                    <Button autoCapitalize={false} variant="contained" color="primary" style={{ backgroundColor: '#3751FF' }}>
                        <Typography style={{ fontFamily: 'Poppins', textTransform: 'initial' }}> See all blogs </Typography>
                    </Button>
                </MaterialUILink>
            </div>
        </div>
