...
import { Card,IconButton, CardContent, CardActions, Collapse,  Divider, Typography, makeStyles, useMediaQuery,Grid, Paper, useTheme } from '@material-ui/core';
  ...
  return (
    <div id="feature" className={classes.root}>
      ...
      <div style={{paddingLeft:5, paddingRight:5, textAlign:'center'}}>
        <Typography style={{fontFamily:'Poppins',marginBottom:10, fontWeight:'bold', fontSize:'2vmin'}} color="black">
        How javascript works behind the scenes
        </Typography>
        <Typography  color="textSecondary" style={{fontFamily:'Poppins',lineHeight:'3.5vmin', fontSize:'1.8vmin'}}>
